...
// --- SYNTHETIC DATA with Date objects instead of strings ---
const gasData = {
  // === THE CHANGE IS HERE ===
  // We now store the dates as actual JavaScript Date objects.
  labels: [
    ...
    <div>
      <header className="dashboard-header d-flex justify-content-between align-items-center">
        ...
        <div className="d-flex align-items-center">
          <a href="../index.html" className="btn btn-sm btn-outline-secondary me-3" target="_blank" rel="noopener noreferrer">Back to Portfolio</a>
        ...
        <div className="row justify-content-center my-4">
          <div className="col-md-4">
            ...
            <select id="week-select" className="form-select" value={selectedWeekIndex} onChange={(e) => setSelectedWeekIndex(parseInt(e.target.value, 10))}>
              {/* Now we format the Date objects for display */}
